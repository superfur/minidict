...
function parse(html) {
    ...
    $('#phrsListTab .pronounce').each((_, element) => {
        ...
        if (match) {
            ...
            (_a = output.phonetics) === null || _a === void 0 ? void 0 : _a.push({
                type,
                value: match[1]
            });
        }
    ...
    $('#phrsListTab .trans-container li').each((_, element) => {
        ...
        if (text) {
            ...
            (_a = output.translations) === null || _a === void 0 ? void 0 : _a.push({
                type,
                trans
            });
        }
    ...
    $('#bilingual li').each((_, element) => {
        ...
        if (english)
            (_a = output.examples) === null || _a === void 0 ? void 0 : _a.push(english);
        if (chinese)
            (_b = output.examples) === null || _b === void 0 ? void 0 : _b.push(chinese);
    });
